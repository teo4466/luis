...
<script>
  ...
  export default {
    ...
    computed: {
      formTitle () {
        return this.editedIndex === -1 ? 'Empleado Nuevo' : 'Editar Empleado'
      },
    },
    ...
    methods: {
      ...
      editItem (item) {
          ...
          let path=`http://localhost:8000/api/v1.0/Empleado/${item.id}/`
      ...
      deleteItemConfirm () {
         let path=`http://localhost:8000/api/v1.0/Empleado/${this.editedItem.id}/`
      ...
      save () {
        ...
        if (this.editedIndex > -1) {
          ...
          axios.put(path, this.editedItem ).then((response)=>{
              ...
              swal('Empleado editado exitosamente!','','')
            ...
            let path='http://localhost:8000/api/v1.0/Empleado/'
              ...
              this.editedItem.direccion=response.data.direccion
              this.editedItem.telefono=response.data.telefono
              swal('empleado creado exitosamente!','','')
